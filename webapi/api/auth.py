...
# also envoyExtAuthzHttp sends original HTTP method lol
@bp.route("/verify", methods=["GET", "POST", "PUT", "DELETE", "PATCH"], defaults={"path": ""})
@bp.route("/verify/<path:path>", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
@login_required
